...
const Menu = () => {
    ...
    const handleSortChange = (option) => {
        ...
        switch (option) {
            // case "default": filterItems(selectedCategory);sortedItems = [...filteredItems];break;
            ...
            case "low-to-high": sortedItems.sort((a, b) => a.price - b.price); break;
            case "high-to-low": sortedItems.sort((a, b) => b.price - a.price); break;
            default: break;
        }
            ...
            <div className="section-container bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FCFCFC] to-100%">
                <div className="py-48 flex flex-col justify-center items-center gap-8">
                    <div className="text-center space-y-7 px-4">
                        ...
                        <p className="text-xl text-[#4A4A4A] md:w-4/5 mx-auto">Come with family and feel the joy of mouthwatering food such as Pizza, Lasagne, Sushi, Paneer Tikka, Dosa and more for a moderate cost</p>
            ...
            <div className="section-container">
                <div className="flex flex-col md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8">
                    <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4 flex-wrap">
                        ...
                        <button onClick={() => filterItems("Indian")} className={selectedCategory === "Indian" ? "active" : ""}>Indian</button>
                        ...
                        <button onClick={() => filterItems("popular")} className={selectedCategory === "popular" ? "active" : ""}>Popular</button>
                    </div>
