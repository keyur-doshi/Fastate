        ...
        if(hostingImage.data.success){
            ...
            if((await postMenuItem).status === 200) {
                ...
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: `${data.name} successfully uploaded on Fastate!`,
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div className='form-control w-full mb-9'>
                            ...
                            <input type="number" step=".01" {...register("price", { required: true })} placeholder="Price (in INR)" className="input input-bordered w-full" />
                        </div>
                    </div>
                    <div className="form-control">
                        ...
                        <textarea {...register("recipe")} className="textarea textarea-bordered h-24" placeholder="Tell the world about your recipe"></textarea>
                    </div>
                    <div className="form-control w-full my-9">
                        <label className="label">
