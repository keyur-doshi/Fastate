...
const serviceLists = [
    {id: 1, title: "Catering", des: "Delight your guests with our flavours and  presentation", image:"/images/home/services/icon1.png"},
    ...
    {id: 4, title: "Gift Cards", des: "Give the gift of exceptional dining with Fastate Gift Cards", image:"/images/home/services/icon4.png"}
]
const OurServices = () => {
    return (
           ...
           <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="md:w-1/2">
                    <div className="text-left md:w-4/5">
                        ...
                        <h2 className="title">Our Culinary Journey And Services Offered</h2>
